...
databind:function(){
  var that = this
  utils.http({
    url: app.globalData.siteUrl + '/Main/Member/GetMyMessageList?devicetype=3',
    data: {
  ...
  goother:function(e){
    ...
    utils.http({
      url: app.globalData.siteUrl + '/Main/Member/UpdateMessage?devicetype=3&uid=' + wx.getStorageSync('SessionUserID'),
      method: "post",
      data: {
        uid: wx.getStorageSync('SessionUserID'),
